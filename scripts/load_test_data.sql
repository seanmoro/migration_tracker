...
-- Usage: sqlite3 resources/database/migrations.db < scripts/load_test_data.sql
...
-- Phase 1: logs-archive (1000 objects, 95% complete)
INSERT OR IGNORE INTO migration_data (id, created_at, last_updated, timestamp, migration_phase_id, user_id, source_objects, source_size, target_objects, target_size, type, target_scratch_tapes) VALUES
...
-- Phase 2: backups-2024 (500 objects, 60% complete)
INSERT OR IGNORE INTO migration_data (id, created_at, last_updated, timestamp, migration_phase_id, user_id, source_objects, source_size, target_objects, target_size, type, target_scratch_tapes) VALUES
...
-- Phase 3: media-files (2000 objects, 90% complete)
INSERT OR IGNORE INTO migration_data (id, created_at, last_updated, timestamp, migration_phase_id, user_id, source_objects, source_size, target_objects, target_size, type, target_scratch_tapes) VALUES
...
-- Phase 4: database-backups (750 objects, 67% complete)
INSERT OR IGNORE INTO migration_data (id, created_at, last_updated, timestamp, migration_phase_id, user_id, source_objects, source_size, target_objects, target_size, type, target_scratch_tapes) VALUES
...
-- Phase 5: excluded-data (300 objects, 25% complete - needs attention)
INSERT OR IGNORE INTO migration_data (id, created_at, last_updated, timestamp, migration_phase_id, user_id, source_objects, source_size, target_objects, target_size, type, target_scratch_tapes) VALUES
...
-- Phase 6: video-content (1500 objects, no progress yet - just reference)
